...
import { AuthGuard } from './RBAC/auth/auth.guard';
...
export const publicRouters: Routes = [
  ...
  { path: 'auth', loadChildren: () => import('./RBAC/auth/auth.module').then(m => m.AuthModule) },
...
export const layoutRouters: Routes = [
  { path: '', component: LayoutComponent,
    children:[
      ...
      { path: 'admins', loadChildren: () => import('./RBAC/admins/admins.module').then(m => m.AdminsModule), canLoad: [AuthGuard]},
    ],
    canLoad: [AuthGuard]
  },
];
